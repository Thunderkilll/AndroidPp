...
import com.sim.mundylingo.Adapters.SavedCoursAdapters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent i = new Intent(CoursPrefActivity.this , CourDetailsActivity.class);
                CoursPrefActivity.this.overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                startActivity(i);
