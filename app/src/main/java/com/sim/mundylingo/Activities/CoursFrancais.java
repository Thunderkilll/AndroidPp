...
import com.sim.mundylingo.Adapters.CoursAdapter;
import com.sim.mundylingo.Helpers.RecyclerTouchListener;
...
import static com.sim.mundylingo.Fragment.CoursFragment.selectedCour;

public class CoursFrancais extends AppCompatActivity {

    public String url = "http://41.226.11.252:1180/lingued/miniProjetWebService/Langue/cours/selectCourParLangue.php?langue=1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cour_fr);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (levelID > ConvertToInt(currentUser.getLevelFr())) {
                    Toast.makeText(CoursFrancais.this, "  your level is low for this course please finish the level first ", Toast.LENGTH_SHORT).show();

                } else {
                    //redirect to cours details

                    Intent intent = new Intent(CoursFrancais.this, ConjugaisonDetailActivity.class);
