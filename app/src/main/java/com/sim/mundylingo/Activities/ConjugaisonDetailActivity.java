...
public class ConjugaisonDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedCour.getLangue().equals("2")) {
            ...
            score = Integer.valueOf(currentUser.getScoreEng());
            ...
            conjuBody = selectedCour.getConjugaison();
            orthoBody = selectedCour.getOrthographe();
            score = Integer.valueOf(currentUser.getScoreFr());
            ...
            conjuBody = selectedCour.getConjugaison();
            orthoBody = selectedCour.getOrthographe();
            score = Integer.valueOf(currentUser.getScoreGer());
            ...
            conjuBody = selectedCour.getConjugaison();
            orthoBody = selectedCour.getOrthographe();
            score = Integer.valueOf(currentUser.getScoreSpan());
...
//        });
    ...
    public void GoToQuestion(View view) {
        Intent intent = new Intent(ConjugaisonDetailActivity.this, Question1Activity.class);
